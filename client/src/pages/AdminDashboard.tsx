...
import { CategoryData, CustomerData, CustomerRequest, NotificationData, ProductData, UserData } from '../data/types';
import { addCategories, addCustomerRequests, addCustomers, addProducts, addUsers, getNotifications } from '../redux/adminRedux';
...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    if (user?.isAdmin && user.accessToken) {
      ...
      getAdminData<CustomerData[]>(dispatch, '/customers', user?.accessToken, user?.isAdmin, addCustomers)
    }
